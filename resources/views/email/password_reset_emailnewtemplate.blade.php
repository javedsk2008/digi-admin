...
<table class="body-wrap borderFourSite">
    <tr>
        <td class="container">
            ...
            <div class="head-text">Reset / Change your password</div>
                    </td>
                </tr>
                <tr>
                    <td class="content">
                        <h2><em>Dear {{ $user['full_name'] }},</em></h2>
                        <p>A request to reset password was received from your Global Grahak account for the email id - {{ $user['email'] }}<br />Customer ID : {{ $user['slug'] }}</p>
                        <table>
                            <tr>
                                <td align="left">
                                    <p>
                                        <a href="{{ $reset_link }}" target="_blank" class="green-button text-center">Check here to reset your password and login</a>
                                    </p>

                                </td>
                            </tr>
                        </table>
            <p><b>Note :</b> This link is valid for 1 hour from the time it was sent to you and can be used to change your password only once.</p><br />
