...
<form class="form_validation" method="POST" action ="{{Config('app.url')}}/edit_mcq" enctype="multipart/form-data">
                
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <div class="box box-primary">
            <div class="box-header with-border">
            <h3 class="box-title">Edit MCQ</h3>
            </div>
            ...
            <div class="box-body"> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <div class="form-group">
                    <label for="optiond">Option D Answer<span class="red-color">*</span> </label>
                    <input type="text" class="form-control optioncls validate[required]"  value="{{$data['rowsubques']['op_d']}}" id="optiond" name="optiond"  placeholder="Enter Option D" > 
                    </div>                    
                    </div>    
                </div>  
                ...
                <div class="row">
                    ...
                    <option value="A" {{$data['rowques']['answer'] == 'A'?'selected':''}} >Option A</option>
                    <option value="B" {{$data['rowques']['answer'] == 'B'?'selected':''}} >Option B</option>
                    <option value="C" {{$data['rowques']['answer'] == 'C'?'selected':''}} >Option C</option>
                    <option value="D" {{$data['rowques']['answer'] == 'D'?'selected':''}} >Option D</option>
                    </select>                            
                    </div>                    
                    </div> 
