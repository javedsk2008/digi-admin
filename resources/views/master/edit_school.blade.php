...
@endif
<form class="form_validation" method="POST" action ="{{Config('app.url')}}/edit_school" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="form-group"> 
                        <input type="hidden" name="sc_id" id="sc_id"  value="{{$data['row']['sc_id']}}">                      
