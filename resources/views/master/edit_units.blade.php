...
@endif
<form class="form_validation" method="POST" action ="{{Config('app.url')}}/edit_units" enctype="multipart/form-data">
            ...
            <div class="box-body">
               ...
               <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text"  id="un_name" name="un_name" value="{{$data['row']['un_name']}}" class="form-control validate[required]" placeholder="Enter unit name"  >                            
                        </div>                    
                    </div>  
                </div>
