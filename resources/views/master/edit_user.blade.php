...
@endif
<form class="form_validation" method="POST" action ="{{Config('app.url')}}/edit_user" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="row"> 
                    <div class="col-md-12">
                        ...
                        <button type="submit" class="btn btn-success typesubmit pull-right float-right" style="margin-top:3px;margin-left:10px;">Update</button>
                        </div>                                    
                    </div>                
                </div>
            </div>
