...
@endif 
        ...
        <div class="box box-primary">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="select2-purple">
                    <select class="select2 all_course_class all_class" readonly name="subcourse[]" multiple="multiple" onchange="all_course_class();" data-placeholder="Select a Class" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="select2-purple">
                    <select class="select_course2 all_course_class all_course" readonly name="subcourse[]" multiple="multiple" onchange="all_course_class();" data-placeholder="Select a Course" data-dropdown-css-class="select2-purple" style="width: 100%;">
                          @foreach($data['classtable'] as $cls)
                          @if($cls->type == '2')
                          <option value="{{$cls['cl_id']}}"  {{in_array($cls['cl_id'], $data['allrow_sccid'])?'selected':''}}  >{{$cls['cl_name']}}</option> 
                          @endif
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      <label for="auther_name">Auther Name<span class="red-color">*</span> </label>
                      <input type="text" class="form-control validate[required]" id="auther_name" name="auther_name" value="{{$data['row']['auther_name']}}" placeholder="Enter Auther Name" > 
                  </div>                    
              </div>
              </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      <label for="book_image">Image<span class="red-color"></span> </label>
                            <a href="{{$data['row']['book_image']}}" target="_blank"><img src="{{$data['row']['book_image']}}" style="width:100px;height:100px;"></a>
                    </div>                    
              </div>
              <div class="col-md-6">
                  <div class="form-group">
         ...
         <div class="row"> 
                    <div class="col-md-12">
                        <div class="form-group">              
                        <a href="{{Config('app.url').'/'.'view_subjects'}}"><button type="button" class="btn btn-default">Back</button>
                        </div>                                    
                    </div>                
                </div>   
